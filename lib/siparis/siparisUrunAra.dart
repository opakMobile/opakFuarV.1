                          ...
                          onPressed: () async {
                            ...
                            if(okumaModu == true){
                              if(stokKartEx.tempList.length == 1){
                                  double gelenMiktar =stokKartEx.tempList[0].guncelDegerler!.carpan!;
                                          ...
                                          children: [
                                            ...
                                            Card(
                                              ...
                                              child: Container(
                                                ...
                                                child: TextFormField(
                                                  onTap: () => aramaMiktarController[
                                                          index].selection = TextSelection(baseOffset: 0, extentOffset: aramaMiktarController[
